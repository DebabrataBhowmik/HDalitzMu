{
    ...
    vector<TString> outpath = {
        ...
        "/data4/chenghan/muon/miniTree/UL2016preVFP/miniTree_HDalitz_ggF_mmg_120_UL2016preVFP_MuPhoTrig.root",
        "/data4/chenghan/muon/miniTree/UL2016preVFP/miniTree_HDalitz_VBF_mmg_120_UL2016preVFP_MuPhoTrig.root",
        "/data4/chenghan/muon/miniTree/UL2016preVFP/miniTree_HDalitz_WH_mmg_120_UL2016preVFP_MuPhoTrig.root",
        "/data4/chenghan/muon/miniTree/UL2016preVFP/miniTree_HDalitz_ZH_mmg_120_UL2016preVFP_MuPhoTrig.root",
        "/data4/chenghan/muon/miniTree/UL2016preVFP/miniTree_HDalitz_ttH_mmg_120_UL2016preVFP_MuPhoTrig.root",
        "/data4/chenghan/muon/miniTree/UL2016preVFP/miniTree_HDalitz_bbH_mmg_120_UL2016preVFP_MuPhoTrig.root",

        "/data4/chenghan/muon/miniTree/UL2016preVFP/miniTree_HDalitz_ggF_mmg_130_UL2016preVFP_MuPhoTrig.root",
        "/data4/chenghan/muon/miniTree/UL2016preVFP/miniTree_HDalitz_VBF_mmg_130_UL2016preVFP_MuPhoTrig.root",
        "/data4/chenghan/muon/miniTree/UL2016preVFP/miniTree_HDalitz_WH_mmg_130_UL2016preVFP_MuPhoTrig.root",
        "/data4/chenghan/muon/miniTree/UL2016preVFP/miniTree_HDalitz_ZH_mmg_130_UL2016preVFP_MuPhoTrig.root",
        "/data4/chenghan/muon/miniTree/UL2016preVFP/miniTree_HDalitz_ttH_mmg_130_UL2016preVFP_MuPhoTrig.root",
        "/data4/chenghan/muon/miniTree/UL2016preVFP/miniTree_HDalitz_bbH_mmg_130_UL2016preVFP_MuPhoTrig.root"
    };
    ...
    for (size_t i =0; i < inpath.size(); i++){
        ...
        for (size_t j = 0; j < variation.size(); j++){
            printf ("=========================== variation: %s ==============================\n", variation[j].Data());
            xAna(inpath[i], outpath[i], xs[i], 19.52, "UL2016preVFP", "MuPhoTrig", variation[j], true);
        }
    }
